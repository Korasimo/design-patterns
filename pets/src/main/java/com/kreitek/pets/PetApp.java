...
public class PetApp {
    ...
    static DebugLogger debugLogger = DebugLogger.getInstance();

    public static void main (String[] args) {
        ControllerFactory controllerFactory = new ControllerFactory();
        boolean end = false;
        debugLogger.debug("Pet app has been initiated"); // TODO Logger
        while (!end) {
        ...
        debugLogger.debug("Pet app has been ended"); // TODO Logger
    }
